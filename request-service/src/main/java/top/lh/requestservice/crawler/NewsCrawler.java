package top.lh.requestservice.crawler;
...
public class NewsCrawler {
    private static final String TARGET_URL = "https://write.qq.com/portal/article";
        ...
        try (CloseableHttpClient httpClient = HttpClients.custom()
            ...
            try (CloseableHttpResponse response = httpClient.execute(httpGet)) {
                ...
                if (entity != null) {
                    ...
                    Object[] titleNodes = rootNode.evaluateXPath("//*[@id=\"body\"]/div/div/div/div/div/ul/li/div");
